...
int main(int argc,char *argv[])
{
	...
	while(flag){
        ...
        if(!flag){
            iSend = sendto(sClient,buf_send,sizeof(buf_name),0,(struct sockaddr*)&ser,sizeof(ser));
            ...
            iSend = sendto(sClient,buf_send,sizeof(buf_name),0,(struct sockaddr*)&serl,sizeof(serl));
        }
        else {
